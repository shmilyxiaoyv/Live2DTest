        ...
        welcome: function () {
            if (document.referrer !== "" && document.referrer.indexOf(current.root) === -1) {
                ...
                if (hour > 22 || hour <= 5) {
                    ...
                    text = '中午了，工作了一个上午，现在是午餐时间！要好好吃饭哦！';
                }
                ...
                modules.render(prop.content.welcome || "欢迎来到coyude的博客！");
            }
        },
        // 触摸
        touch: function () {
            current.canvas.onclick = function () {
                modules.render(prop.content.touch || ["你在干什么？", "再摸我就报警了！", "HENTAI!", "不可以这样欺负然比我啦！"]);
            };
        },
        // 右侧按钮
        buttons: function () {
